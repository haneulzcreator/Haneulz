...
export default function HaneulzStory() {
  ...
  const loadStoryImages = async () => {
    try {
      ...
      setImages({
        cover: data.story_cover_image || "",
        hanSiren: data.story_han_siren_image || "",
        littlePrince: data.story_little_prince_image || "",
        group: data.story_group_image || "",
        littleMoments: data.story_little_moments_image || "",
        final: data.story_final_image || "",
      });
    } catch (error) {
      console.error(
        "Failed to load HANEULZ story images:",
        error
      );
    }
  };
    ...
    <article className="relative mx-auto w-full max-w-6xl overflow-hidden rounded-[2rem] bg-[#f4ebe6] text-[#40383f] shadow-[0_24px_80px_rgba(70,55,65,0.16)] sm:rounded-[2.5rem] lg:rounded-[3rem]">
      ...
      <section className="relative px-6 pb-8 pt-5 sm:px-8 sm:pb-10 sm:pt-6 md:px-16 lg:px-24">
        ...
        <div className="mt-5 max-w-4xl sm:mt-6">
          <StoryParagraph>
            ...
            to sound like <i>haneul</i> (하늘), which means sky
            in Korean. I honestly think it fits them so well
            because it started from just their names, but somehow
            it became this little name that holds so many memories
            from Universe League until now.
          </StoryParagraph>
        </div>
      ...
      <section className="relative px-6 pb-7 pt-1 sm:px-8 sm:pb-9 md:px-16 lg:px-24">
        ...
        <div className="mt-5 max-w-4xl sm:mt-6">
          ...
          <StoryParagraph>
            Before HANEULZ was even a thing, Han and JL were
            just two trainees trying to make it through Universe
            League. They didn't start out as some inseparable
            pair or anything like that. They had their own
            stages, their own teams, and their own moments, and
            that's actually what makes their story so fun to look
            back on.
          </StoryParagraph>
          ...
          <StoryParagraph>
            ...
            was there too. During one of the drafting episodes,
            he became known as the “three pick” because three
            mentors chose him. Like… three. ㅋㅋㅋㅋ It really
            showed how much of an impression he was already making.
          </StoryParagraph>
      ...
      <section className="relative px-6 pb-8 pt-5 sm:px-8 sm:pb-10 sm:pt-6 md:px-20 lg:px-32">
        ...
        <StoryParagraph>
          Then came Han with “Siren.” His whole vibe was
          completely different. He had that mysterious aura
          when he walked onto the stage, and then once he started
          singing, you could really hear how strong his voice was.
      ...
      <section className="relative mx-4 my-5 rounded-[2rem] border border-[#d9c5ce]/60 bg-[#fff8f4]/55 px-6 py-8 sm:mx-6 sm:my-7 sm:rounded-[2.5rem] sm:px-9 sm:py-10 md:mx-10 md:px-14 lg:mx-16">
        ...
        <div className="mt-5 max-w-4xl sm:mt-6">
          ...
          <StoryParagraph>
            And then there's the funniest part because one of
            Han's first impressions of JL wasn't some dramatic
            first meeting. JL literally entered the wrong practice
            room. ㅋㅋㅋㅋ He opened the door to the Siren practice
            room looking completely confused and went,
            “Eugh? This isn't One and Only team?” before realizing
            he was in the wrong room and leaving.
          </StoryParagraph>

          <StoryParagraph>
            Han remembered how funny his expression was, and
            honestly, that is such a HANEULZ way for their story
            to start.
          </StoryParagraph>
      ...
      <section className="relative px-6 pb-8 pt-5 sm:px-8 sm:pb-10 sm:pt-6 md:px-16 lg:px-24">
        ...
        <div className="mt-5 max-w-4xl sm:mt-6">
          ...
          <StoryParagraph>
            Then December 27, 2024 happened. The Little Prince.
            After seeing Han and JL doing their own thing
            throughout the competition, they finally got to sing
            together. And honestly, what else am I supposed to say
            except… their voices sounded so good together.
          </StoryParagraph>

          <StoryParagraph>
            Han's voice and JL's voice have their own colors,
            but they didn't fight each other. They actually fit
            together really naturally. Their harmonies made the
            whole performance feel so much fuller, and it was one
            of those stages where you could just sit there and
            listen without thinking about anything else.
          </StoryParagraph>

          <StoryParagraph>
            Even the trainees watching them reacted to it, with
            some of them saying they got goosebumps. And I
            completely understand why because hearing those two
            voices together for the first time was just…
            yeah. HANEULZ.
          </StoryParagraph>

          <StoryParagraph>
            That performance became such an important part of
            their story because it was one of the first times we
            really got to see what happens when Han and JL share
            the same stage instead of watching them separately.
          </StoryParagraph>
      ...
      <section className="relative mx-4 my-6 overflow-hidden rounded-[2.5rem] border border-[#736878]/20 bg-[#655967] px-6 py-9 text-[#faf4ef] shadow-[0_18px_55px_rgba(70,55,65,0.16)] sm:mx-6 sm:my-8 sm:rounded-[3rem] sm:px-9 sm:py-12 md:mx-10 md:px-14 lg:mx-16 lg:px-20">
        ...
        <div className="relative">
          ...
          <div className="mt-5 max-w-4xl">
            ...
            <StoryParagraph dark>
              After everything that happened during Universe
              League, Han and JL eventually debuted together as
              members of AHOF on July 1, 2025. And honestly,
              this is probably one of my favorite parts of their
              whole story because after watching them go through
              the competition, seeing them actually end up in the
              same group felt so satisfying.
            </StoryParagraph>

            <StoryParagraph dark>
              Together with Steven, Jeongwoo, Woongki, Shuaibo,
              Chih En, Juwon, and Daisuke, they started this new
              chapter with AHOF's debut album <i>Who We Are</i>
              and the title track “그곳에서 다시 만나기로 해
              (Rendezvous).”
            </StoryParagraph>

            <StoryParagraph dark>
              And of course, HANEULZ didn't just disappear after
              debut. If anything, we started getting even more
              little moments.
            </StoryParagraph>
      ...
      <section className="px-6 pb-8 pt-5 sm:px-8 sm:pb-10 sm:pt-6 md:px-20 lg:px-32">
        ...
        <StoryParagraph>
          One of the things that always makes me smile is how
          often Han and JL end up singing together. Han has talked
          about how JL is good at harmonizing and how beautiful
          his high notes are, and there have been so many moments
          where the two of them just casually start singing
        ...
        <StoryParagraph>
          There are also all those random little moments that
          don't necessarily look important on their own but
          somehow become the things you remember. JL giving Han
          jelly. Han eating it. Them sharing food. The random
          photos. Han leaning on JL because he was tired and JL
          suddenly taking a picture. Their random duets. Calling
          each other by their nicknames. Those little “Hani
          hyung~” moments. The way they can turn literally
          nothing into a whole interaction.
        </StoryParagraph>

        <StoryParagraph>
          There was even the mafia game moment where Han talked
          about JL always saving him when he was about to die and
          how he thought it was better doing it with JL because
          JL was good at harmonizing and his high notes were
          beautiful.
        </StoryParagraph>
      ...
      <section className="px-6 pb-8 pt-5 sm:px-8 sm:pb-10 sm:pt-6 md:px-20 lg:px-32">
        ...
        <StoryParagraph>
          YES. THAT. Because at that point HANEULZ wasn't just
          something fans were calling them. They knew the name
          too.
        </StoryParagraph>

        <StoryParagraph>
          There are so many little things like this that I could
          honestly keep going forever. Sometimes they're singing,
          sometimes they're joking around, sometimes they're just
          sitting together, and sometimes it's literally just one
      ...
      <section className="relative mx-4 my-6 overflow-hidden rounded-[2.5rem] border border-[#b8ced0]/55 bg-[#edf3f0]/70 px-6 py-9 sm:mx-6 sm:my-8 sm:rounded-[3rem] sm:px-9 sm:py-11 md:mx-10 md:px-14 lg:mx-20 lg:px-20">
        ...
        <div className="mt-5 max-w-4xl sm:mt-6">
          ...
          <StoryParagraph>
            And then there's Hansum. Hansum comes from Han's
            fandom name, Park Ha-dan, and JL's nickname, DimSUM.
            It also connects to the Korean word 한숨, which means
            a sigh or a deep breath.
          </StoryParagraph>

          <StoryParagraph>
            I actually really like that meaning because this whole
            little corner is kind of like that too. A place where
            you can just breathe for a second, look back at the
            memories, replay the performances, save the funny
      ...
      <section className="relative px-6 pb-10 pt-5 sm:px-8 sm:pb-13 sm:pt-6 md:px-16 lg:px-24">
        ...
        <div className="mt-5 max-w-4xl sm:mt-6">
          ...
          <StoryParagraph>
            ...
            performance or one funny interaction. It started with
            two trainees who didn't even know that they were going
            to end up together. One accidentally walked into the
            wrong practice room. They eventually sang The Little
            Prince together. Then somehow, after everything, they
          ...
          <StoryParagraph>
            ...
            times they randomly start singing together. All of
            those tiny things that probably felt ordinary when
            they happened but became memories that people kept
            coming back to.
          </StoryParagraph>

          <StoryParagraph>
            That's what this corner is for. Not to make their story
            sound bigger or more dramatic than it is, but just to
            keep the moments that made HANEULZ feel like HANEULZ
            in one place.
          </StoryParagraph>
...
/* =============================================================
   STORY IMAGE
   Loads the image selected from Admin Panel.
============================================================= */
